 ...
 */
public class InsuranseTest extends BaseTest {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//a[@aria-label='Раздел Застраховать себя  и имущество']"))));
        ...
        //Переход на новую страницу и ожидание загрузки необходимого элемента
